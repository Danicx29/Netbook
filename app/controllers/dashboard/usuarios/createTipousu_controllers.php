...
try{
    ...
    if(isset($_POST['crearPermiso'])){        
        ...
        if($object->setnombre_tipoUsu($_POST['nombre'])){
            ...
            if($object->createPermisos()){
                Page::showMessage(1, "Tipo de usuario creado", "Tipo_usuarios.php?pagina=1");
            }else{
...
require_once("../../app/views/dashboard/usuarios/createTipousu_view.php");
