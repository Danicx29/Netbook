<form method='post' autocomplete=off enctype='multipart/form-data'>
    <div class="container">
        ...
        <div class="row">
            <div class="col s12 m12">
                <div class="card  blue-grey darken-1">
                    <div class="card-content white-text">
                        <span class="card-title center">Agregar tipo usuario</span>
            ...
            <div class='col s6 m4'>
                <p>
                    <input type="checkbox" id="permLibros" name="permLibros" />
            ...
            <div class='col s6 m4'>
                <p>
                    <input type="checkbox" id="permAutYEdit" name="permAutYEdit" />
            ...
            <div class='col s6 m4'>
                <p>
                    <input type="checkbox" id="permCategoria" name="permCategoria" />
            ...
            <div class='col s6 m4'>
                <p>
                    <input type="checkbox" id="permUsuario" name="permUsuario" />
            ...
            <div class='col s6 m4'>
                <p>
                    <input type="checkbox" id="permSolicitudes" name="permSolicitudes" />
