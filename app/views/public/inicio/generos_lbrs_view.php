<main class=''>
<div class='row'>
<h4 class='light-blue-text text-accent-1 center-align'>Genero disponibles </h4>
    <?php
        foreach($Generos as $Genero){
                print("
                    <div class='col s12 m4 l4 '>
                        <div class='card   blue-grey darken-4'>
                            <div class='card-content hoverable   light-blue-text'>
                                <span class='card-title'>$Genero[nombre_genero]</span>
                                <p class='white-text'>$Genero[descripcion_genero]</p>
                            </div>
                            <div class='card-action  blue-grey darken-3'>
                                <a  class=' light-blue-text text-accent-1' href='libros_genero.php?id=$Genero[id_genero] '  class='light-blue-text '>Ver libros</a>
                            </div>
                        </div>
                    </div>
                ");
