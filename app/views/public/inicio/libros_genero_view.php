...
<div class='row'>
    <?php
        foreach($libros as $Genero){
                print("
            <div class='col s12 m3 l3'>
                <div class='card  grey lighten-5'>
                    <div class='card-image waves-effect waves-block waves-light'>
                    <img class='activator' src='../../web/img/libros/$Genero[foto]'>
                    </div>
                    <div class='card-content grey lighten-5' >
                    <span class='card-title activator grey-text text-darken-4'>$Genero[nombre_libro]<i class='material-icons right'>more_vert</i></span>
                    <p><a href='#'>Comprar por: $Genero[precio_libro]</a></p>
                    </div>
                    ...
                    <p>$Genero[descripcion_libro]</p>
                    <span class='card-title grey-text text-darken-4'>Escrito:</span>
                    <p>$Genero[nombre_autor]</p>
                    <span class='card-title grey-text text-darken-4'>Numero de paginas:</span>
                    <p>$Genero[numeroPag_libro]</p>
