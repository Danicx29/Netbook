                                ...
                                <div class="center-align cuadrado "> 
                                    ...
                                    <form method='post'>
                                         ...
                                         <div class="row">
                                                <div class=" black-text  col s12 m12 l12 ">
                                                    <a href="registrarse.php"> 
                                                        <button class="red btn waves-effect waves-light" type="submit" name="action">Registrarse
                                                            <i class=" material-icons right"></i>
                                                        </button>
                                                    </a>
                                                </div>
                                        ...
                                        <div class="row">
                                                <div class=" black-text  col s12 m12 l12 ">
                                                    <a href="login.php"> 
                                                        <button class="grean btn waves-effect waves-light" type="submit" name="action">Iniciar sesion
                                                            <i class=" material-icons right"></i>
                                                        </button>
                                                    </a>
                                                </div>
