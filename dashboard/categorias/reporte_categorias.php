...
{ 
    ...
    // celda(ancho en cm,alto en cm,texto para mostrar,borde,ajustar celda,alineacion de la celda,color de fondo)
    $this->Cell(0,1,utf8_decode('Libros del autor:'.$valores[0]),0,0,'C',false);  
    // Line break
    $this->Ln(1);
}
// Page footer
...
$header = array( utf8_decode('ventas'),'libro','editorial','autor','valor'); 
...
$data=$categoria->GetReporteCategoria($_GET['editorial']);
$editorial=$categoria->GetdatosCategoria($_GET['editorial']);
$fpdf->AddPage();  
...
$fpdf->SetFont('Arial',"",18);   
    ...
    $fpdf->Cell(0,1,utf8_decode('No hay libros de esta categoria'),0,1,'C',false);
}
